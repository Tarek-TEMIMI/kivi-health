...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function initialize()
	{
		...
		if (is_admin()) {
			...
			add_action('admin_enqueue_scripts', array( $this, 'iqonic_sale_admin_script') );
		}
	...
	// Iqonic Sale admin script
	function iqonic_sale_admin_script() {
		...
		add_action('admin_footer', function() {
			...
			<script>
				(function ($) {
					'use strict';
					$( document ).ready(() => {
						$( ".iq-notice" ).on( "click", function (event) {
