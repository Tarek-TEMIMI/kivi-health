...
class Component implements Component_Interface
{
	...
	{
		//add_action('import_start', array( $this, 'kivicare_before_demo_setup' ) );
	...
	// public function kivicare_before_demo_setup() {
	// 	$shop_id = get_page_by_path( 'shop' );
	// 	wp_delete_post( $shop_id->ID, true );
	// }
	...
	public function kivicare_after_import_setup()
	{
		...
		if($id) {
            update_option('woocommerce_shop_page_id', $id->ID);
        }
		...
		// global $wpdb;
		// $wpdb->insert( 'wp-test-three', array('permalink' => $permalink));

		add_action( 'init', function() {
            global $wp_rewrite;
            $wp_rewrite->set_permalink_structure( 'index.php/%year%/%monthnum%/%postname%/' );
        } );
