...
<div class="text-center">
    ...
    <div class="d-flex flex-wrap gap-1 justify-content-center kc-confirmation-buttons">
        ...
        <button  onclick="window.location.href='https://backend.omniacom.com/wordpress/wp-admin/admin.php?page=dashboard#/';" type="button" class="iq-button iq-button-primary d-none"  id="kivicare_add_to_calendar">
        Dashboard
        </button>
