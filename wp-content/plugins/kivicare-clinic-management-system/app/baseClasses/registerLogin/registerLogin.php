    ...
    <div class="kivi-widget"  dir='<?php echo esc_html($rtl_attr); ?>'>
        <div id="kivi-content" style="display:none;">
            ...
            <ul class="nav-tabs"><?php
                ...
                if(!is_user_logged_in()){
                    if(isset($login) && $login){?>
                        <li class="tab-item <?php if(isset($register) && !$register){ echo esc_html__("active","kc-lang"); }?>">
            ...
            <div id="login-register-panel">
                <?php
                    $login_tab_class = (isset($register) && $register) ? 'd-none' : '';
                    if(isset($register) && $register){
                ?>
                <form id="kivicare-register-form" enctype="multipart/form-data">
                    <div id="register" class="iq-fade autActive">
                        <div>
                            <div  id="kivicare-register">
                                ...
                                ?>
                                <?php
                                if (!empty($clinic) && count($clinic)) {
                                    ?>
                                    <div class="form-group">
                                        <label class="form-label"
                                            for="userClinic"> <?php echo esc_html__('Select Clinic', 'kc-lang'); ?>
                                            <span>*</span></label>
                                        <select name="user_clinic" class="iq-kivicare-form-control" id="userClinic"
                                            ...
                                            foreach ($clinic as $key => $value) {
                                                ?>
                                                <option value="<?php echo esc_html($value->id); ?>" <?php echo esc_html($key == 0 ? 'selected' : ''); ?>><?php echo esc_html($value->name); ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                ...
                <?php } ?>
                <form id="kivicare-login-form" class="<?php echo esc_html( $login_tab_class )?>">
